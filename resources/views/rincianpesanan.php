    ...
    <main class="p-6">
        ...
        <section class="bg-white p-6 rounded shadow-md mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <p class="text-gray-700"><strong>Nomor Pesanan:</strong> #123456</p>
                    <p class="text-gray-700"><strong>Tanggal:</strong> 27 Juni 2024</p>
                    <p class="text-gray-700"><strong>Status:</strong> Dalam Proses</p>
                </div>
                <div>
                    <p class="text-gray-700"><strong>Total:</strong> Rp1.200.000</p>
                    <p class="text-gray-700"><strong>Metode Pembayaran:</strong> Kartu Kredit</p>
                </div>
            </div>
        </section>
