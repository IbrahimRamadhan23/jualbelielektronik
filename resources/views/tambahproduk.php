    ...
    <nav class="bg-gray-700 border-gray-200 dark:bg-gray-900">
        <div class="flex flex-row">
             <div class="pl-5 sm:flex sm:items-center w-2/6 ">
                ...
                <p class=" text-amber-300 text-3xl ml-5">TAMBAH PRODUK</p>
            </div>
        </div>
    ...
    <div class="max-w-4xl mt-14 mx-auto bg-gray-200 p-8 rounded-lg ">
        ...
        <form class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                <button type="submit" class="w-full bg-yellow-400 text-black font-bold p-2 rounded-md hover:bg-yellow-300 transition duration-200">Tambah Produk</button>
            </div>
        </form>
    </div>
</body>