...
<body>
    <nav class="bg-gray-700 border-gray-200 dark:bg-gray-900">
        ...
        <p class=" text-amber-300 text-3xl ml-5">CHECK OUT</p>
        </div>
    </nav>
    ...
    <div class=" mt-4 mx-4 pl-15">
            <div class="w-10/11">
                <div class="flex flex-row bg-gray-100 rounded p-4">
                    <img src="location.png" alt="Product Image" class="h-11 my-5 object-cover rounded-t">
                    <div class="pl-10 flex flex-col w-96">
                        <h3 class="text-lg font-bold">Aditya Ahmadi</h3>
                        <p class="text-gray-600">Jl. Brigjen Katamso Batam Kota. Kota Batam. kepulauan Riau. Indonesia</p>
                    </div>
                </div>
            </div>
